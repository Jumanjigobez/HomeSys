...
const Personal_Timetable = () => {
  ...
  const handleAddTimetable = (e) => {
    ...
    axios({
      method: "post",
      url: api_url + "/personalTimetable.php",
      data: formData,
      params: { user_id: user },
      config: {
        headers: {
  ...
  const handleUpdateTimetable = (e, row_id) => {
    ...
    axios({
      ...
      method: "post",
      url: api_url + "/personalTimetable/editPersonalTimetable.php",
      data: formData,
      config: {
        headers: {
          "Content-Type": "multipart/form-data",
  ...
  const handleDeleteTimetable = (e, row_Id) => {
    ...
    axios({
      ...
      method: "get",
      url: api_url + "/personalTimetable/deletePersonalTimetable.php",
      params: { id: row_Id },
  ...
  useEffect(() => {
    ...
    axios({
      method: "get",
      params: { user_id: user },
      url: api_url + "/personalTimetable/getPersonalTimetable.php",
    })
      .then((response) => {
