...
const Personal_Timetable = () => {
  ...
  const handleAddTimetable = (e) => {
    ...
    axios({
      method: "post",
      url: "http://localhost:8080/HOMESYS V1.0/homesys/PHP/personalTimetable.php",
      data: formData,
      config: {
        headers: {
  ...
  const handleUpdateTimetable = (e, row_id) => {
    ...
    axios({
      ...
      method: "post",
      url: "http://localhost:8080/HOMESYS V1.0/homesys/PHP/personalTimetable/editPersonalTimetable.php",
      data: formData,
      config: {
        headers: {
          "Content-Type": "multipart/form-data",
  ...
  const handleDeleteTimetable = (e, row_Id) => {
    ...
    axios({
      ...
      method: "get",
      url: "http://localhost:8080/HOMESYS V1.0/homesys/PHP/personalTimetable/deletePersonalTimetable.php",
      params: { id: row_Id },
  ...
  useEffect(() => {
    ...
    axios({
      method: "get",
      url: "http://localhost:8080/HOMESYS V1.0/homesys/PHP/personalTimetable/getPersonalTimetable.php",
    })
      .then((response) => {
                          ...
                          <tr key={row.id}>
                            ...
                            <td className="actions">
                              <button
                                ...
                                onClick={(e) => openDialogPersonalT("edit", e)}
                              >
      ...
      {isDialogOpen && (
        <div className="dialog_container">
          <div className="dialog_box">
            ...
            <div className="title_part">
              <h2>{dialogFields.dialogTitle} Personal Timetable</h2>
            </div>
...
export default Personal_Timetable;
