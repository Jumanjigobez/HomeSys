...
const Todo = () => {
  ...
  const handleTodoSubmit = (e) => {
    ...
    let Todo_val = Todo.current.value,
      api_url = "http://localhost:8080/Homesys%20v1.0/homesys/PHP/todo.php",
  ...
  const handleDoneTodo = (e, task_id) => {
    ...
    axios({
      ...
      method: "get",
      url: "http://localhost:8080/Homesys%20v1.0/homesys/PHP/todo/markTodos.php",
      params: { id: task_id },
  ...
  const handleUpdateTodo = (e, task_id) => {
    ...
    axios({
      ...
      method: "post",
      url: "http://localhost:8080/Homesys%20v1.0/homesys/PHP/todo/updateTodos.php",
      data: formData,
      config: {
        headers: {
          "Content-Type": "multipart/form-data",
  ...
  const handleDeleteTodo = (e, task_id) => {
    ...
    axios({
      ...
      method: "get",
      url: "http://localhost:8080/Homesys%20v1.0/homesys/PHP/todo/deleteTodos.php",
      params: { id: task_id },
      withCredentials: false,
    })
      .then((response) => {
  ...
  useEffect(() => {
    ...
    axios({
      method: "get",
      url: "http://localhost:8080/Homesys%20v1.0/homesys/PHP/todo/getTodos.php",
    })
      .then((response) => {
